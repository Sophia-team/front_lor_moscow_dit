    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                html.P(
                    id="description",
                    children="Предиктивная платформа, содержащая API, генерирующий рекомендации для каждого конкретного полигона о превентивных мерах по борьбе с распространением инфекции, и приложение для просмотра сценариев (введение QR-кодов, блокировка льготных билетов на общественный транспорт, ношение масок, удаленная работа, вакцинация и так далее) распространения инфекции. А также индивидуальный сервис оповещения о возможном риске заражения (чат-бот).",
                ),
            ],
        ),
        html.Div(
